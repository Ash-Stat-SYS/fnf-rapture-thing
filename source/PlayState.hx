	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'stage': //Week 1
				...
				case 'hallway': 
				var bg:BGSprite = new BGSprite('Week4BG', -700, -200, 0.9, 0.9);
				add(bg);
			...
			case 'alleyway': 
				var bg:BGSprite = new BGSprite('alleywayback', -600, -200, 0.9, 0.9);
				add(bg);

				var alleywayFront:BGSprite = new BGSprite('alleywayfront', -650, 600, 0.9, 0.9);
				alleywayFront.setGraphicSize(Std.int(alleywayFront.width * 1.1));
				alleywayFront.updateHitbox();
				add(alleywayFront);
