...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Rapture Team'],
			['Jinx',                    'jinx',         'Director Artist Animator And BG Artist',                'https://twitter.com/G3T_J1NX3D',      '0xFFF28C28'],
			['Viva',                    'vi',           'Co-Director The Only One Charter And Writer',                  'https://twitter.com/Glitchy2260',     '0xFF32CD32'],
			...
			['Jayfii',                    'jay',         'Rapturifying Our Characters',                            'https://twitter.com/Jayfii_',       '0xFFEA3C53'],
			...
			['Starlight Zone',                'starlight',        'No Songs Used In This Build',               'https://twitter.com/StarlightZone7',                            '0xFF0892D0'],
			['Coquers_',                      'coquers',    'Made Frightened And The Sour Feelings Week Songs',      'https://twitter.com/Coquers1',                            '0xFFFF355E'],
			['Ora',                            'ora',             'Made The Game Over Theme',                       'https://twitter.com/oran_is',                            '0xFF1E90FF'],
			['SirFitness',                     'sirf',           'No Songs Used In This Build',                   'https://twitter.com/sfgamertalks',                            '0xFFF9F6EE'],
			['Oliver',                         'oliver',         'Writer',                                              '',                            '0xFFA4C639'],
			['Neen',                            'neen',           'Writer And Voice Actor',                        'https://twitter.com/TakoNeen',                            '0xFFFFFF66'],
 			['Psych Engine Team'],
